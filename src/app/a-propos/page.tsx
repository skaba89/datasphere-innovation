...
const TEAM_MEMBERS = [
  {
    ...
    description:
      "12 ans d'expérience en conseil data et stratégie digitale. Sophie a accompagné plus de 30 entreprises dans la définition et la mise en œuvre de leur roadmap data. Experte en gouvernance des données et change management, elle insuffle une vision stratégique à chaque projet.",
    icon: Database,
  },
  {
    name: "Thomas Dubois",
    ...
    description:
      "10 ans d'expérience en data engineering et architecture data. Thomas maîtrise l'écosystème complet : dbt, Airflow, Spark, Snowflake, Databricks. Il conçoit des pipelines robustes et scalables qui alimentent les décisions métier en temps réel.",
    icon: Workflow,
  },
  {
    name: "Léa Chen",
    ...
    description:
      "8 ans d'expérience en intelligence artificielle et machine learning. Léa spécialisée dans le NLP, la vision par ordinateur et le MLOps. Elle dirige le pôle IA et garantit que chaque modèle déployé en production génère un ROI mesurable.",
    icon: BrainCircuit,
  },
  {
    name: "Marc Petit",
    ...
    description:
      "11 ans d'expérience en architecture cloud et infrastructure data. Marc certifié AWS, Azure et GCP, il accompagne les entreprises dans leur migration cloud et leur transformation infrastructure avec une approche FinOps orientée résultats.",
    icon: Cloud,
  },
];
  ...
  return (
    <>
      ...
      <main id="main-content" aria-label="Contenu principal" className="min-h-screen flex flex-col">
        ...
        {/* Notre Histoire */}
        <section className="section-padding bg-background" role="region" aria-label="Notre histoire">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-heading font-bold mb-6">
              Notre <span className="gradient-text">histoire</span>
            </h2>
            <p className="text-muted-foreground mb-6 text-base">
              DataSphere Innovation est un cabinet de conseil né de la conviction que la data et l&apos;IA peuvent transformer
              la prise de décision, l&apos;innovation et la création de valeur dans les organisations.
            </p>
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                , les entreprises axées sur les données sont 23 fois plus susceptibles d&apos;acquérir des clients. C&apos;est cette conviction qui guide notre action au quotidien. Comme le souligne{" "}
                <a
                ...
                , d&apos;ici 2026, plus de 80% des entreprises auront adopté l&apos;IA dans leurs processus — nous les accompagnons pour que cette adoption soit un succès. Selon{" "}
                <a
                ...
                , les entreprises qui investissent dans l&apos;IA et la data obtiennent un avantage compétitif significatif et durable.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Notre Mission */}
        <section className="section-padding bg-secondary/20" role="region" aria-label="Notre mission">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-4 text-base">
                Notre mission est de rendre la data et l&apos;IA accessibles, utiles et performantes pour chaque organisation.
              </p>
        ...
        {/* Nos Valeurs */}
        <section className="section-padding bg-background" role="region" aria-label="Nos valeurs">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground/70 max-w-2xl mx-auto text-sm">
                L&apos;excellence, l&apos;innovation, le partenariat, l&apos;impact, l&apos;intégrité et la collaboration
                sont les piliers de notre identité et de notre engagement envers nos clients.
              </p>
            </div>
        ...
        {/* Notre Équipe — Team Members with Person Schema */}
        <section className="section-padding bg-secondary/20" role="region" aria-label="Notre équipe">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-heading font-bold mb-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mb-3">
                ...
                obsession : votre succès data. Découvrez les leaders qui pilotent
                nos pôles d&apos;expertise.
              </p>
              <p className="text-muted-foreground/70 max-w-2xl mx-auto text-sm">
                Nos leaders possèdent en moyenne plus de 10 ans d&apos;expérience et sont
                reconnus dans leurs domaines respectifs :{" "}
                <Link href="/services/data-strategy" className="text-primary hover:underline">stratégie data</Link>,{" "}
                <Link href="/services/data-engineering" className="text-primary hover:underline">data engineering</Link>,{" "}
                <Link href="/services/ai-solutions" className="text-primary hover:underline">intelligence artificielle</Link> et{" "}
                <Link href="/services/cloud-modernization" className="text-primary hover:underline">architecture cloud</Link>.
              </p>
            </div>
        ...
        {/* Nos Atouts */}
        <section className="section-padding bg-background" role="region" aria-label="Nos atouts">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-heading font-bold mb-4">
              ...
              <p className="text-muted-foreground/70 max-w-2xl mx-auto text-sm">
                Notre expertise ciblée, notre impact mesurable et notre approche sur mesure
                sont confirmés par les retours de nos clients.{" "}
                <Link href="/#temoignages" className="text-primary hover:underline">Découvrez leurs témoignages</Link>.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="section-padding bg-secondary/20" role="region" aria-label="Partenaires et clients">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-heading font-bold mb-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Des leaders de l&apos;industrie aux startups innovantes, nos clients et partenaires
                technologiques témoignent de la qualité de notre expertise.
              </p>
            </div>
